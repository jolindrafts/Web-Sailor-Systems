        ...
        <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a href="rtgSailors.php">Rata-Rata Rating Sailors</a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <header class="panel-heading">
                            Report Rata-Rata Rating Sailors
                        </header>
                        <br />
                        <a href="#"onclick="window.print()">
                            <button class="btn btn-success">
                                <i class="fa fa-print"></i> Print Report Rating Sailors
                            </button>
                        </a>
                        <hr />
                        <table class="table  table-hover general-table">
                            ...
                            <?php
                                ...
                                while($getViewSailor=mysqli_fetch_row($viewAllSailors))
                                {
                                    ...
                                    <?php
                                    $no=$no+$getViewSailor[2];
                                    $noa++;
                                }
                            ?>
                            <tr>
                                <td colspan="2"><h4><b>Jumlah Rating Sailors</b></h4></td>
                                <td><h3><?php echo"$no";?></h3></td>
                            </tr>
                            <tr>
                                <td colspan="2"><h4><b>Rata-Rata Rating Sailors</b></h4></td>
                                <td><h3><?php echo $no/$noa;?></h3></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
