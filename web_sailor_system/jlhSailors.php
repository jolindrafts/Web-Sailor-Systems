    ...
    <div id="sidebar" class="nav-collapse">
        <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li class="active"><a href="jlhSailors.php">Jumlah Sailors</a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <header class="panel-heading">
                            Report Jumlah Sailors
                        </header>
                        <br />
                        <a href="#"onclick="window.print()">
                            <button class="btn btn-success">
                                <i class="fa fa-print"></i> Print Report Sailors
                            </button>
                        </a>
                        <hr />
                        <table class="table  table-hover general-table">
                            ...
                            ?>
                            <tr>
                                <td colspan="3"><h4><b>Jumlah Sailors</b></h4></td>
